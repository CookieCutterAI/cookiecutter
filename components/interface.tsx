...
export function Interface() {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#F5F5F5] text-[#333]">
      <header className="bg-[#F5F5F5] p-4  flex justify-between items-center /75">
        <img src="logo-dark-removebg-preview.png" className="w-28 h-28 rounded-full" alt="logo"/>
      ...
      <div className="flex flex-col items-center p-4 bg-[#F5F5F5]">
        <form onSubmit={handleSubmit} className="flex justify-center items-center w-full max-w-md mb-5">           
          ...
          />
        <button className="inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-slate-800 bg-[linear-gradient(110deg,#271249,45%,#b725c4,55%,#271249)] bg-[length:200%_100%] px-6 font-medium text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50" onClick={() => setChatText(true)}>
            Send
        </button>
      ...
      <main className="flex-1 overflow-auto p-4">
        <div className="max-w-[50em] mx-auto shadow-xl rounded-lg bg-[#F5F5F5] p-6 textArea">
